 ...
 *
 * Регистрации на странице входа нет намеренно: пока игрок один, заводить
 * учётную запись проще отсюда, а открытая регистрация на машине без TLS —
 * это дверь, за которой пока некому следить.
 */
