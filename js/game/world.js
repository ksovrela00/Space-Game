...
//   * орбитальные периоды огромны (годы), поэтому тела практически стоят.
//     Модель полёта не использует вращающуюся систему отсчёта, а планета,
//     идущая по орбите быстрее корабля, делает стыковку невозможной:
//     станция «убегала» бы из-под носа быстрее, чем корабль подкрадывается
//     к порту. Вращение самих планет и станций при этом хорошо заметно.
