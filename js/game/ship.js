...
export const SHIP = {
  ...
  maxHull: 100,
  // Щитов на корпусе НЕТ: поле стоит нулём, потому что карточка корабля
  // обязана показывать и то, чего не установлено, — иначе пустая строка
  // читается как поломка прибора, а не как «этого у тебя нет».
  maxShield: 0,
